...
int main() {
    ...
    while (test--) {
        ...
        string res = "YES";
        // Check if every side length appears an even number of times
        ...
        if (res == "YES") {
            sort(a.begin(), a.end());
            int target_area = a[0] * a.back();
            
            // Check pairing: smallest with largest, skipping every 2nd element
            // because sides must come in pairs.
